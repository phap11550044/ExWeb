    ...
    .addEventListener("click", (e) => {
      ...
      modal.querySelector(".addButton").addEventListener("click", function (e) {
        ...
        if (username.value === "") {
          ...
          username.focus();
          return;
        } else if (!regexSpecialCharForUsername.test(username.value)) {
          ...
          fullname.focus();
          return;
        } else if (!regexSpecialCharForFullName.test(fullname.value)) {
          alert("Nhập họ và tên không chứa ký tự đặc biệt.");
          fullname.focus();
          return;
        } else if (!regexFullName.test(fullname.value)) {
          alert("Nhập họ và tên đúng định dạng (ví dụ: Lữ Minh).");
          fullname.focus();
          return;
          ...
          alert(
            "Nhập địa chỉ không đúng định dạng (ví dụ: 173A/32 Dương Quảng Hàm)."
          );
          diachi.focus();
          return;
        } else if (role.value === "") {
