...
function changeAddressTmp() {
 ...
 addressTmp =
  ...
  " " +
  checked.querySelector(".sdt").innerHTML +
  "</b> " +
...
var phuongXaData = {
 ...
 "Thị Xã Mường Lay": ["Phường Sông Đà", "Phường Na Lay", "Xã Lay Nưa"],
 "Huyện Mường Nhé": [
  "Xã Sín Thầu",
  "Xã Sen Thượng",
  "Xã Chung Chải",
 ...
 "Huyện Phú Quí": ["Xã Ngũ Phụng", "Xã Long Hải", "Xã Tam Thanh"],
 "Kon Tum": [
  "Phường Quang Trung",
  "Phường Duy Tân",
  "Phường Quyết Thắng",
...
function changeQuanHuyen() {
 var tinhthanh_data = document.getElementById("tinhthanh").value;
 var quanHuyenSelect = document.getElementById("quanhuyen");
 quanHuyenSelect.innerHTML = "";
 var quanHuyenArray = quanHuyenData[tinhthanh_data];
 if (quanHuyenArray) {
...
function changePhuongXa() {
 var quanHuyen_data = document.getElementById("quanhuyen").value;
 var phuongXaSelect = document.getElementById("phuongxa");
 phuongXaSelect.innerHTML = "";
 var phuongXaArray = phuongXaData[quanHuyen_data];
 if (phuongXaArray) {
...
$(document).ready(function () {
 ...
 $(document).ready(function () {
  ...
  $(".confirm.create_address").click(function (e) {
   e.preventDefault();
   if (validFormUpdateUserInfoAddress()) {
    const updateFullnameValue = updateFullname.value;
    const updatePhoneNumberValue = updatePhoneNumber.value;
 ...
 $(".confirm.change_address").click(function (e) {
  e.preventDefault();
  if (validFormUpdateUserInfoAddress()) {
...
function validFormUpdateUserInfoAddress() {
 ...
 } else if (updatePhoneNumber.value.length !== 10) {
  // Kiểm tra độ dài của số điện thoại
  isValidPhoneNumber = false;
  messageError += "\n - Số điện thoại phải đúng 10 chữ số";
 } else if (updatePhoneNumber.value[0] !== "0") {
  // Kiểm tra xem số đầu tiên có phải là số 0 không
  isValidPhoneNumber = false;
  messageError +=
   "\n - Số điện thoại phải bắt đầu bằng số 0 (ví dụ: 0931814480)";
 } else if (!regexPhoneNumber.test(updatePhoneNumber.value)) {
  // Kiểm tra tổng thể tính hợp lệ của số điện thoại
  isValidPhoneNumber = false;
  messageError += "\n - Số điện thoại không hợp lệ (chỉ chứa các số từ 0-9)";
 } else {
 ...
 if (citySelect.value === "Chọn Tỉnh/Thành phố") {
  isValidCity = false;
...
window.addEventListener("scroll", function () {
 ...
 const mountPosition = totalHeight - footerHeight - formSubmit.offsetHeight;

 if (scrollPosition >= mountPosition + 280) {
  formSubmit.style.position = "relative";
  formSubmit.style.marginBottom = "2px";
 } else {
  formSubmit.style.position = "fixed";
 }
});
